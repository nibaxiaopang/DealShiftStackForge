...
class StackForgeFeedbackViewController: UIViewController {
    ...
    @IBAction func btnSubmit(_ sender: Any) {
        ...
        if isStarSelected {
            clearAllStars()
            StackForgeUtils.showAlert(title: "Thanks for feedback", message: "Your feedback added successfully", from: self)
        } else {
            StackForgeUtils.showAlert(title: "No Selection", message: "Please select a rating before submitting.", from: self)
        }
    }
